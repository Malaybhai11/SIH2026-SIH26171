// ALTERNATE / EXPERIMENTAL OCR ENGINE — not wired into PerceptionEngine.
//
// The shipped OCR engine is ../ocr.js (Tesseract.js), selected because it has a
// full eval (eval/ocr_eval.mjs -> eval/results/ocr.json: 20/20 images, 100%
// object recall) proving it end-to-end on the demo ID-card/receipt corpus and
// on the E2 red-team canvas-bitmap page (0% leak once wired in).
//
// This file is a from-scratch PP-OCRv4 (DBNet + CTC) ONNX pipeline: real
// detection/recognition math, no eval run against it yet. Kept here, unwired,
// as a documented alternate path rather than discarded — swap it in via
// PerceptionEngine's `./ocr.js` import if you want to pursue a lighter-weight
// (~15 MB vs Tesseract's ~17 MB) ONNX-native OCR instead of Tesseract.js.
// To fetch its models: node scripts/fetch_models.mjs --ppocr-alt
//
